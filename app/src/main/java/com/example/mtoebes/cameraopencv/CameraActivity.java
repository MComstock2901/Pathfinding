...
public class CameraActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void takePhoto(View view) {
        ...
        File imgFile = FileHelper.saveMat(mRgba);
        Intent intent = new Intent(this.getBaseContext(), ImageDisplayActivity.class);
        intent.putExtra(ImageDisplayActivity.EXTRA_FILE_PATH, imgFile.getPath());
