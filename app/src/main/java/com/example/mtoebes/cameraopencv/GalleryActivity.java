...
public class GalleryActivity extends ListActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<File> data =  FileHelper.getBitmapFiles(FileHelper.DEFAULT_TAG); // TODO get files with tag=DEFAULT_TAG to show in Gallery
    ...
    private class GalleryItem implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if(v.getId() == (mDeleteButton.getId())) { // delete mFile
                ...
                Intent intent =
                        new Intent(mContext, ImageDisplayActivity.class);
